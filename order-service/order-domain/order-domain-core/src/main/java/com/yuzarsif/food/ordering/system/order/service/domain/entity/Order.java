...
import com.yuzarsif.domain.entity.AggregateRoot;
import com.yuzarsif.domain.valueobject.*;
import com.yuzarsif.food.ordering.system.order.service.domain.exception.OrderDomainException;
import com.yuzarsif.food.ordering.system.order.service.domain.valueobject.OrderItemId;
import com.yuzarsif.food.ordering.system.order.service.domain.valueobject.StreetAddress;
import com.yuzarsif.food.ordering.system.order.service.domain.valueobject.TrackingId;
...
public class Order extends AggregateRoot<OrderId> {
    ...
    private void validateItemPrice(OrderItem orderItem) {
        if (!orderItem.isPriceValid()) {
            throw new OrderDomainException("Total price: " + price.getAmount()
                + " is not equal to Order items total: " + orderItem.getSubTotal().getAmount() + "!");
        }
    }
